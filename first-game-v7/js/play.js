...
var playState = {
	...
	create: function(){
		...
		if (!game.device.desktop) {
			...
			//call the 'orientationChange' when the device is rotated
			game.scale.onOrientationChange.add(this.orientationChange, this);
			
			//call the function at least oncellchange
	...
	movePlayer: function(){
		...
		if (game.input.totalActivePointers == 0) {
			//make sure the player is no moving
			this.moveLeft = false;
	...
	addMobileInputs: function() {
		//add jump button
		var jumpButton = game.add.sprite(350, 240, 'jumpButton'); //place the sprite
		jumpButton.inputEnabled = true; //receive input
		jumpButton.alpha = 0.5; //transparency
		jumpButton.events.onInputDown.add(this.jumpPlayer, this);//call jumpPlayer when the 'jumpButton' is pressed
		...
		var leftButton = game.add.sprite(50, 240, 'leftButton'); //place the sprite
		leftButton.inputEnabled = true; //receive input
		leftButton.alpha = 0.5; //transparency
		...
		var rightButton = game.add.sprite(130, 240, 'rightButton'); //place the sprite
		rightButton.inputEnabled = true; //receive input
		rightButton.alpha = 0.5; //transparency
